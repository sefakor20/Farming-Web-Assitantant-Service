...
$all_products_purchased = fetchItemWithJoin($connection, "purchase.id, farmers.full_name, crop.crop_name, purchase.quantity, purchase_status.name", "purchase", "JOIN farmers ON farmers.id = purchase.farmer_id JOIN crop ON crop.crop_id = purchase.crop_id JOIN purchase_status ON purchase_status.id = purchase.status");

//var_dump($all_products_purchased);exit();
