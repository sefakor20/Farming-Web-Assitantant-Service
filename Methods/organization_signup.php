...
if(isset($_POST['submit'])){
	...
	if (!empty($admin)) {
		...
		header('location: ../Organization/signup.php');
		exit();
	}
	...
	if ($password === $confirm_password) {
		...
		$query = "INSERT INTO buying_organization (organization_name, organization_contact, username, password, created_at) VALUES('$organization_name', '$organization_contact', '$username', '$password', NOW())";
		mysqli_query($connection, $query);
		$_SESSION['success'] = "Account created successfully Login to Continue";
