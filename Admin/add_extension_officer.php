...
<html lang="en">
  ...
  <head>
    ...
    <title>Add New Extension Officer</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Extension Officer</li>
        </ol>
        ...
        <div class="col-lg-10 col-md-12 col-sm-12 offset-2"><br><br>
          <div class="card mb-112">
            <div class="card-header">
              <h3>Add New Extension Officer</h3>
            </div>
            <div class="card-body">
              <form method="POST" action="../Methods/admin_add_extension_officer.php">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Full Name</label>
                      <input type="text" name="full_name" pattern="[A-Za-z]+" class="form-control" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="phone" pattern="[0-9]+" class="form-control" required>
                    </div>
                  </div>
                </div>
                <div class="row">
