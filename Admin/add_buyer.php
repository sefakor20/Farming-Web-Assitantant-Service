      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-10 col-md-12 col-sm-12 offset-2"><br><br>
          <div class="card mb-112">
            ...
            <div class="card-body">
              <form method="POST" action="../Methods/admin_add_buyer.php">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Organization Name</label>
                      <input type="text" name="organization_name" pattern="[A-Za-z]+" class="form-control" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="organization_contact" class="form-control" pattern="[0-9]+" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
