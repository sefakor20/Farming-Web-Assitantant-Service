        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default" ">
                ...
                <div class="panel-body">
                    <form method="POST" action="../Methods/extension_officer_signup.php">
                     ...
                     <span style="font-size: 17px;"><center>I Already have an account. <a href="login.php">&nbsp; Login </a></span></center>
                </div>
            </div>
        </div>    
    </div>
